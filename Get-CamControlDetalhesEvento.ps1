<#
.SYNOPSIS
    Funcao do modulo CamControl para obter os detalhes de um evento relacionado a uma camera.
...
.PARAMETER Id
    Pode-se indicar o parametro -Id para informar o id de um evento, o id do evento pode ser obtido com o comando Get-CamControlEventos.

.EXAMPLE
    Get-CamControlDetalhesEvento -Server localhost -Id 1

.NOTES
    Esta funcao tem a finalidade de obter os detalhes de um evento de cameras cadastradas na aplicacao CamControl. Deve ser aberto uma sessao com a aplicacao previamente a utilizacao deste comando.
...
#>
function Get-CamControlDetalhesEvento {
    [CmdletBinding()]
    param (
    ...
    process {
        ...
        $apiUrl = "http://${Server}/CAMCONTROL/rest/RestControllerDetalhesEvento.php"
...
Export-ModuleMember -Function 'Get-CamControlDetalhesEvento'